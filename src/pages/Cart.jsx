...
const Cart = () => {
  ...
  const UPI_ID = "9520627396@ptyes";
  const PAYEE_NAME = "Azhar Store";
      ...
      <div className="flex flex-col md:flex-row py-16 max-w-6xl w-full px-6 mx-auto">
        ...
        <div className="flex-1 max-w-4xl">
          ...
          {cartArray.map((product, index) => (
            <div
              key={index}
              className="grid grid-cols-[2fr_1fr_1fr] items-center pt-3 text-gray-600"
            >
              ...
              <button
                onClick={() => removeFromcarts(product._id)}
        ...
        <div className="max-w-[360px] w-full bg-gray-100 p-5 border">
          ...
          <button
            onClick={placeOrder}
            className="w-full py-3 mt-5 bg-indigo-600 text-white"
          >
      ...
      {showPayment && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded w-[320px] text-center">
            ...
            {/* QR CODE */}
            <QRCodeSVG
              value={`upi://pay?pa=yourupi@upi&pn=Your%20Store&am=${finalAmount}&cu=INR`}
              size={200}
            />
